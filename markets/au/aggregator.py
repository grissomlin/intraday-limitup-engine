...
from .builders_au import (
    build_open_limit_watchlist_au,
    build_sector_summary_open_limit_au,
)


def aggregate(payload: Dict[str, Any]) -> Dict[str, Any]:
    """
    AU aggregator (no daily limit):
    ...
    - sector uses ASX GICS industry group original text
    """
    return aggregate_no_limit_market(
        payload,
        market_code="AU",
        watch_builder=build_open_limit_watchlist_au,
        sector_summary_builder=build_sector_summary_open_limit_au,
