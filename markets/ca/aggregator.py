...
from .builders_ca import (
    build_open_limit_watchlist_ca,
    build_sector_summary_open_limit_ca,
)


def aggregate(payload: Dict[str, Any]) -> Dict[str, Any]:
    """
    CA aggregator (no daily limit):
    ...
    return aggregate_no_limit_market(
        payload,
        market_code="CA",
        watch_builder=build_open_limit_watchlist_ca,
        sector_summary_builder=build_sector_summary_open_limit_ca,
