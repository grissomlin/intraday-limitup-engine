# markets/fr/downloader_fr.py
# -*- coding: utf-8 -*-
"""
Thin entrypoint for FR market.
...
from .fr_prices import run_sync as _run_sync_prices
from .fr_snapshot import run_intraday as _run_intraday
