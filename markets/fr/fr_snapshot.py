...
from scripts.render_images_common.i18n import t as _t
...
def _build_time_meta_fr(*, ymd_effective: str, asof: str) -> Dict[str, Any]:
    # France market time: Europe/Paris (DST aware)
    if ZoneInfo is None:
        return {}
    try:
...
def run_intraday(slot: str, asof: str, ymd: str, db_path: Optional[Path] = None) -> Dict[str, Any]:
    ...
    df["market_detail"] = df["market_detail"].fillna("Euronext Paris")
        ...
        snapshot_open.append(
            {
                ...
                "sector": str(r["sector"]),
                "market": "FR",
                "market_detail": str(r.get("market_detail") or "Euronext Paris"),
                "market_label": str(r.get("market_detail") or "Euronext Paris"),
                "bar_date": str(r["ymd"]),
            ...
            rows.append(
                {
                    ...
                    "market": "FR",
                    "market_detail": str(rr.get("market_detail") or "Euronext Paris"),
                    "market_label": str(rr.get("market_detail") or "Euronext Paris"),
                    "bar_date": str(rr["ymd"]),
